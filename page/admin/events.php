  ...
  <div id="main-content" class="flex-1 flex-col min-h-screen transition-all duration-300 ease-in-out w-full">
    ...
    <header
      ...
      <div class="flex items-center gap-3">
        <h2 class="text-base sm:text-lg md:text-xl font-semibold truncate">Events</h2>
      </div>
      ...
      <div class="flex items-center gap-4">
        ...
        <div id="mobile-menu"
          ...
          <div class=" text-textLight rounded-xl ml-0 z-50 w-64 text-left">
            ...
            <a href="./reports.php" class="block p-2 rounded hover:bg-primaryHover transition ttext-left">💬
              Feedbacks</a>
    ...
    <section id="maincontent" class="max-h-80">
      ...
      <p class="text-sm text-textMuted mb-2">' . htmlspecialchars($row['date']) . '</p>
...
<div id="floating-button" class="fixed bottom-0 right-0 mr-3 bg-transparent border border-white text-white rounded-lg px-3 py-2 shadow-lg cursor-pointer transition-transform transform hover:scale-110">
  &nbsp;&nbsp;+ Add&nbsp;&nbsp;
</div>
...
<div id="modal" class="fixed inset-0 bg-black/50 backdrop-blur-sm hidden justify-center items-center transition-opacity duration-300 rounded-lg z-50">
  <div class="bg-card rounded-lg p-6 max-w-md w-full">
    <h2 class="text-lg font-semibold mb-4 text-left">Schedule an Event</h2>
    <form id="announcement-form" action="process/add_event.php" method="POST">
      <div class="mb-4">
        <label for="title" class="block text-sm font-medium">Title</label>
        <input type="text" id="title" name="title" placeholder="Enter Event Title" class="border border-gray-300 rounded w-full p-2 text-textMuted bg-transparent" required>
      </div>
      
      <div class="mb-4">
        <label for="venue" class="block text-sm font-medium">Venue</label>
        <input type="text" id="venue" name="venue" placeholder="Enter Venue" class="border border-gray-300 rounded w-full p-2 text-textMuted bg-transparent" required>
      </div>
      <div class="mb-4">
        <label for="event_date" class="block text-sm font-medium">Event Date</label>
        <input type="date" id="event_date" name="event_date" class="border border-gray-300 rounded w-full p-2 text-textMuted bg-transparent" required>
      </div>
      <div class="mb-4">
